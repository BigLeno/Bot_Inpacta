...
class MessageData:
    ...
    @classmethod
    def get_data(cls, message:object, token:str, time_sleep:int or float, admin:list)-> None:
    ...
    @classmethod
    def manage_delivery(cls, data:tuple, user_data:dict, time_sleep:float or int, cachedirectory:str, user_names:list, user_ids:list, token:str) -> None:
